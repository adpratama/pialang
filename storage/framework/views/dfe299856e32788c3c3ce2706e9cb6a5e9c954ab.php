    ...
    <ul class="navbar-nav flex-fill w-100 mb-2">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
          ...
          <li class="nav-item">
            <a class="nav-link pl-3" href="<?php echo e(route('insurance.index')); ?>"><span class="ml-1 item-text">Insurance</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link pl-3" href="<?php echo e(route('insured.index')); ?>"><span class="ml-1 item-text">Insured</span></a>
          </li>
        </ul>
      </li>
    </ul>
