        ...
        <div class="row my-4">
          ...
          <div class="col-md-12">
            <div class="row align-items-center mb-4">
                ...
                <div class="col-auto">
                  <a href="<?php echo e(route('insurance.create')); ?> " type="button" class="btn btn-secondary" >Tambah</a>          
                </div>
              </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/pialang/resources/views/pages/insurances/index.blade.php ENDPATH**/ ?>