<a href="#" class="btn collapseSidebar toggle-btn d-lg-none text-muted ml-2 mt-3" data-toggle="toggle">
  ...
  <nav class="vertnav navbar navbar-light"  >
    ...
    <div class="btn-box w-100 mt-4 mb-1">
      {{-- <a type="button" class="btn mb-2 btn-primary btn-lg btn-block" href="{{ route('logout') }}">
        <i class="fe fe-log-out fe-12 mr-2"></i><span class="small">Logout</span>
      </a> --}}
      <a class="btn mb-2 btn-primary btn-lg btn-block " href="{{ route('logout') }}"
  onclick="event.preventDefault();
                document.getElementById('logout-form').submit();">
                <i class="fe fe-log-out fe-12 mr-2"></i><span class="small">{{ __('Keluar') }}</span>
