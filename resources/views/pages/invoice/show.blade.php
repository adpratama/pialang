                ...
                <div class="col-sm-4" style="margin-left: 240px">
                    <p>
                        <strong>
                            ...
                            Equivalent to IDR :{{$item->kurs_to_idr}}
                        </strong>
                    </p>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="form-group row" style="margin-bottom:0">              
                    <div class="col-sm-6 ">
                        <p style="margin-bottom:0">E & O E</p> 
                        <p style="margin-bottom:0">Signed For and on behalf of</p> 
                        <p style="margin-bottom:0" ><strong> {{$item->signfor}}</strong></p>
                    </div>
                    <div class=" col-sm-6">    
                        <table border="0">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{$item->premium + $item->policy_cost + $item->stamp_duty}}</td>
                            </tr>
                            <tr style="border-bottom: 1px solid black;">
                                <td >Admin Cost</td>
                            ...
                            <tr>
                                ...
                                <td>{{$item->premium + $item->policy_cost + $item->stamp_duty + $item->admin_cost}}</td>
                            </tr>
                            <tr style="border-top: 1px solid black ">
                                <td ><strong> Equivalent in IDR</strong></td>
                                <td>{{$item->premium + $item->policy_cost + $item->stamp_duty + $item->admin_cost * $item->kurs_to_idr}}</td>
                            </tr>
                        </table>
                    </div>
                </div>
