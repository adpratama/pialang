...
<div class="row">
    <div class="col-md-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form action="{{ route('insurance.update', $item->id) }}" method="POST">
            @csrf     
            @method('PATCH')
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="office" id="office" value="{{old('office')?old('office'):$item->office}} @error('office') is-invalid @enderror ">
                    @error('office')
                        <div class="text-muted">{{ $message}} </div>
                    @enderror
                </div>
