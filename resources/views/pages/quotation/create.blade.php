                ...
                <form action="{{ route('quotation.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <textarea name="insured" class="ckeditor form-control 
                                @error('insured') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="contract_details" class="col-sm-3 col-form-label">
                            DETAILS OF CONTRACT
                        </label>
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <textarea name="contract_details"
                                class="ckeditor2 form-control 

                                @error
                                    ('contract_details') is-invalid 
                                @enderror">{{ old('contract_details')?old('contract_details'):$item->contract_details}}
                            </textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 ">
                            ...
                            <input type="text" 
                                name="scope" 
                                class="form-control 
                                @error ('scope') is-invalid @enderror"
                    ...
                    <div class="form-group row">
                        ...
                        <label for="scope" class="col-sm-3 col-form-label">
                            TERRITORIAL LIMIT
                        </label>
                        ...
                        <div class="col-sm-3 ">
                            ...
                            <input type="text" 
                                name="territorial"
                                class="form-control 
                                @error('territorial') is-invalid @enderror"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <textarea name="employee_details"
                                class="ckeditor3 form-control 
                                @error('employee_details') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="vehicle_details" class="col-sm-3 col-form-label">
                            DETAILS OF VEHICLE
                        </label>
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <textarea name="vehicle_details"
                                ...
                                @error('vehicle_details') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <textarea name="cover_type"
                                class="ckeditor5 form-control 
                                @error('cover_type') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="coverage" class="col-sm-3 col-form-label">
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <textarea name="coverage"
                                class="ckeditor6 form-control 
                                @error('coverage') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <input type="text" 
                                name="warranty"
                                class="form-control 
                                @error('warranty') is-invalid @enderror">
                                {{ old('warranty')}}
                            </input>
                    ...
                    <div class="form-group row">
                        ...
                        <label for="signfor" class="col-sm-3 col-form-label">
                            SIGN FOR
                        </label>
                    ...
                    <div class="form-group row">
                        ...
                        <label for="confirmby" class="col-sm-3 col-form-label">
                            CONFIRMED BY
                        </label>
